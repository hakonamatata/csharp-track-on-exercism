...
public class SqueakyCleanTests
{
    ...
    [Fact]
    public void Last_letter()
    {
        Assert.Equal("abc", Identifier.Clean("abc-"));
    }
    ...
    [Fact]
    public void Middle_letter()
    {
        Assert.Equal("aBc", Identifier.Clean("a-bc"));
    }

    // [Fact]
    // public void First_is_number()
    // {
    //     Assert.Equal("abc", Identifier.Clean("123ab2c"));
    // }
}
